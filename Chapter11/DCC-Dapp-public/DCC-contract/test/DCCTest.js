...
contract('DCC Dapp', (accounts)=>{
    ...
    describe('Events and Eligibility', () => {
        ...
        it('Success on capturing emitted event preRequisiteSatisfied.', async () => {
            ...
            truffleAssert.eventEmitted(result, 'preRequisiteSatisfied', (ev) => {
                return ev.personNumber == 123456789;
            });
            // truffleAssert.eventEmitted(result, 'preRequisiteSatisfied', null);
        });
        ...
        it('Failure on capturing emitted event preRequisiteSatisfied with partial data.', async () => {
            let result = await dcc.checkEligibility(123456789, {from: accounts[1]});
            truffleAssert.eventNotEmitted(result, 'preRequisiteSatisfied', null);
